all.o: parsers/all.cpp parsers/all.hpp ast.hpp types.hpp types/all.hpp \
  types/arch.hpp utility/wrapper.hpp types/rational.hpp \
  utility/rationaltype.hpp utility/bigint.hpp types/float.hpp \
  types/string.hpp types/boolean.hpp types/parenthesis.hpp \
  types/char.hpp types/ops.hpp parsers/opplus.hpp parsers/arch.hpp \
...
opdivide.o: parsers/opdivide.cpp parsers/opdivide.hpp ast.hpp types.hpp \
  types/all.hpp types/arch.hpp utility/wrapper.hpp types/rational.hpp \
  utility/rationaltype.hpp utility/bigint.hpp types/float.hpp \
  types/string.hpp types/boolean.hpp types/parenthesis.hpp \
  types/char.hpp types/ops.hpp parsers/arch.hpp parsers/all.hpp \
...
opmultiply.o: parsers/opmultiply.cpp parsers/opmultiply.hpp ast.hpp \
  ...
  types/parenthesis.hpp types/char.hpp types/ops.hpp parsers/arch.hpp \
...
asttest.o: test/asttest.cpp ast.hpp types.hpp types/all.hpp \
  ...
  utility/rationaltype.hpp utility/bigint.hpp types/float.hpp \
  types/string.hpp types/boolean.hpp types/parenthesis.hpp \
  types/char.hpp types/ops.hpp preprocessor.hpp tokenizer.hpp
biginttest.o: test/biginttest.cpp utility/bigint.hpp
parserstest.o: test/parserstest.cpp preprocessor.hpp tokenizer.hpp \
  types.hpp types/all.hpp types/arch.hpp utility/wrapper.hpp \
  types/rational.hpp utility/rationaltype.hpp utility/bigint.hpp \
  types/float.hpp types/string.hpp types/boolean.hpp \
  types/parenthesis.hpp types/char.hpp types/ops.hpp ast.hpp parsers.hpp \
...
tokenizertest.o: test/tokenizertest.cpp preprocessor.hpp tokenizer.hpp \
  ...
  types/rational.hpp utility/rationaltype.hpp utility/bigint.hpp \
  types/float.hpp types/string.hpp types/boolean.hpp \
  types/parenthesis.hpp types/char.hpp types/ops.hpp
typestest.o: test/typestest.cpp types.hpp types/all.hpp types/arch.hpp \
  utility/wrapper.hpp types/rational.hpp utility/rationaltype.hpp \
...
char.o: types/char.cpp types/char.hpp types/arch.hpp utility/wrapper.hpp \
  types/all.hpp types/rational.hpp utility/rationaltype.hpp \
  utility/bigint.hpp types/float.hpp types/string.hpp types/boolean.hpp \
...
rational.o: types/rational.cpp types/rational.hpp types/arch.hpp \
  ...
  types/all.hpp types/float.hpp types/string.hpp types/boolean.hpp \
  types/parenthesis.hpp types/char.hpp types/ops.hpp \
  utility/simplenum.hpp
string.o: types/string.cpp types/string.hpp types/arch.hpp \
  utility/wrapper.hpp types/all.hpp types/rational.hpp \
  utility/rationaltype.hpp utility/bigint.hpp types/float.hpp \
